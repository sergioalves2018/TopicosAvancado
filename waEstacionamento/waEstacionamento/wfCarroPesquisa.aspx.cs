...
{
    public partial class wfCarroPesquisa : Page
    {
        enum enmGvCadColuna
        {
            acao = 0,
        ...
        protected void lbkLimpar_Click(object sender, EventArgs e)
        {
        }
        ...
        protected void lkbEditar_Click(object sender, EventArgs e)
        {
            ...
            //CarregarTela(new DBMonitoramento().SelectTo(int.Parse(row.Cells[(Byte)enmGvCadColuna.id].Text)));
        }
